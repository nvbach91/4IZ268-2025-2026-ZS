/* ui.js
   Funkce pro vykreslování UI. UI je oddělené od logiky (tasks.js) a storage.
   Vrací/aktualizuje DOM prvky podle index.html.
*/

/* Helper: vytvoří DOM element ze stringu */
 ...
 * Vytvoří DOM element .list-group-item pro daný task.
 * Tlačítka mají data-action a data-id atributy:
 *  - data-action="toggle"
 *  - data-action="delete"
 *  - data-action="edit"
 */
