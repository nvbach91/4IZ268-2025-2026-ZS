/* ----------------------------------------------------------
   tasks.js
   Business logika pro CRUD a filtrování úkolů.
   Závislosti:
     - storage.js (getTasks, saveTasks, addTask, updateTask, removeTask)
     - utils.js (uid, formatISODate)
---------------------------------------------------------- */
...
/**
 * Struktura task objektu (příklad)
 * {
 *   id: "t_163834234",
 *   title: "Dokončit seminárku",
 *   description: "Dopsat kapitolu 3",
 *   category: "Studium",
 *   priority: "normal", // low | normal | high
 *   status: "pending",  // pending | done | archived
 *   due_date: "2025-01-20", // ISO date (YYYY-MM-DD) nebo null
...
/**
 * Vytvoří nový task objekt a uloží ho.
 * @param {Object} data {title, description, category, due_date, priority}
 * @returns {Object} vytvořený task
 */
export function createTask(data = {}) {
  ...
  const task = {
    ...
    status: 'pending',
    due_date: data.due_date || null, // očekává YYYY-MM-DD nebo null
    created_at: now,
    updated_at: now,
    completed_at: null,
    meta: data.meta || {}
