...
decipherForm.addEventListener('submit', (e) => {
    ...
    const encryptedText = formData.get('encrypted-text');
    const decipherKey = formData.get('decipher-key');

    const outputArea = document.getElementById('result-area');

    outputArea.style.display = "flex";
    outputArea.textContent = caesarDecipher(encryptedText, decipherKey);
});
