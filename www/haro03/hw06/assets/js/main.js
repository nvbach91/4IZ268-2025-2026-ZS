...
const caesarDecipher = (cipherText, usedKey) => {
    ...
    const decrypted = shiftString(cipherText, usedKey);
...
textInput.addEventListener("submit", (event) => {
  ...
  const cipherValue = parseInt(formData.get("cipher-value"));

  const result = caesarDecipher(cipherText.toUpperCase(), cipherValue);
