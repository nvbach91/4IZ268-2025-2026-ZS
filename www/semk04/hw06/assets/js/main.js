...
// defines the alphabet I'm working with
...
const shiftChar = (c, shift) => {
    ...
    if (index === -1) return ''; // Ignore non-uppercase letters
...
const shiftString = (str, shift) => {
    ...
    for (let i = 0; i < str.length; i++) {
        ...
        result += shiftChar(char, shift) || char; // Preserve non-alphabet characters
    }
    return result;
};
...
document.getElementById('decipherButton').addEventListener('click', () => {
    ...
    const output = caesarDecipher(cipherText, key);
