        ...
        <div>
            <div className='weather-info-card flex items-center'>
                ...
                <div className='flex justify-end gap-6 w-full whitespace-nowrap'>
                    <div className='flex items-center'><Thermometer/><h2 className='text-3xl'>{weatherData?.info.temperature ?? '--'} &#176;C</h2></div>
                    <div className='flex items-center'><Droplets/><h2 className='text-3xl'>&nbsp;{weatherData?.info.precipitation ?? '--'} %</h2></div>
                    <div className='flex items-center'><Wind/><h2 className='text-3xl'>&nbsp;{weatherData?.info.windSpeed ?? '--'} m/s</h2></div>
                </div>
            </div>
